...
namespace Karkas.CodeGenerationHelper.Generators
{
    ...
    public class BsWrapperGenerator : BaseGenerator
    {
        ...
        public void Render(IOutput output, IContainer container)
        {
            ...
            string outputFullFileNameGenerated = Path.Combine(utils.FileUtilsHelper.ProjeDizininiAl(database) + "\\BsWrapper\\" + baseNameSpace + ".BsWrapper\\" + schemaName, classNameTypeLibrary + "BsWrapper.generated.cs");
            string outputFullFileName = Path.Combine(utils.FileUtilsHelper.ProjeDizininiAl(database) + "\\BsWrapper\\" + baseNameSpace + ".BsWrapper\\" + schemaName, classNameTypeLibrary + "BsWrapper.cs");
