...
namespace Karkas.CodeGenerationHelper.Generators
{
    public class InsertScriptsGenerator
    {
        ...
        public void Render(IOutput output, ITable table, string connectionString)
        {
            ...
            output.save(Path.Combine(utils.FileUtilsHelper.ProjeDizininiAl(table.Database) + "\\Database\\InsertScripts\\" + table.Schema, table.Schema + "_" + table.Name + ".Inserts.sql"), false);
            output.clear();
